                    ...
                    <div>
                        <div class="top-slider__item">
                            <div class="top-slider__item--left">
                                <p class="top-slider-subtitle">Специальное предложение</p>
                                <p class="top-slider-title">Центробежные <br>
                                    насосы Leo
                                </p>
                                <p class="top-slider-text">Однофазный, центробежный насос серии 3.0 от компании Leo
                                    мощностью 1.1 кВт,
                                    предназначен для перекачивания чистой воды и может применяться для бытового
                                    водоснабжения</p>
                                <div class="top-slider-goods-set">
                                    ...
                                    <div class="row top-slider-goods-set__all">
                                        <div class="col-12"><a href="#" class="link-arrow"><span>подробнее</span></a>
                                        </div>
                                    </div>
...
<div class="container section-block">
    <div class="row hidden-xl-up">
        <div class="col-12">
            <div class="block-orange-bg">
                <div class="block-orange-bg__image">
                    <img src="img/jpeg_files/goods-lg-1.png" alt="card">
                </div>
                <p class="block-orange-bg__subtitle">Специальное предложение</p>
                <p class="block-orange-bg__title">Центробежные <br>
                    насосы Leo
                </p>
                <p class="block-orange-bg__text">Однофазный, центробежный насос серии 3.0 от компании Leo
                    мощностью 1.1 кВт,
                    предназначен для перекачивания чистой воды и может применяться для бытового
                    водоснабжения</p>
                <a href="" class="block-orange-bg__btn">
                    <span class="block-orange-bg__btn--prop">от ₴ 12 600</span>
                    <span class="link-arrow"><span>подробнее</span></span>
                </a>
            </div>
        </div>
    </div>
    <div class="row align-content-lg-stretch">
        <div class="col-lg-6 col-xl-3">
            <div class="block-w-border">
                <p class="title-md">МЫ В СОЦСЕТЯХ</p>
                <p class="block-w-border__text">Подпишитесь и получите максимум интересной информации, будьте в курсе
                    всех новостей и лучших предложений</p>
                        ...
                        <div class="four-item-slider">
                            <div>
                                <div class="main-brand">
                                    <a href="#">
                                        <img src="img/jpeg_files/brand-1-inverse.png" class="main-brand__second"
                                             alt="brand" height="38" width="152">
                                        <img src="img/jpeg_files/brand-1.png" class="main-brand__first" alt="brand"
                                             height="38" width="152">
                                    </a>
                                </div>
                            </div>
                            <div>
                                <div class="main-brand">
                                    <a href="#">
                                        <img src="img/jpeg_files/brand-2-inverse.png" class="main-brand__second"
                                             alt="brand" height="27" width="153">
                                        <img src="img/jpeg_files/brand-2.png" class="main-brand__first" alt="brand"
                                             height="27" width="153">
                                    </a>
                                </div>
                            </div>
                            <div>
                                <div class="main-brand">
                                    <a href="#">
                                        <img src="img/jpeg_files/brand-3-inverse.png" class="main-brand__second"
                                             alt="brand" height="36" width="146">
                                        <img src="img/jpeg_files/brand-3.png" class="main-brand__first" alt="brand"
                                             height="36" width="146">
                                    </a>
                                </div>
                            </div>
                            <div>
                                <div class="main-brand">
                                    <a href="#">
                                        <img src="img/jpeg_files/brand-4-inverse.png" class="main-brand__second"
                                             alt="brand" height="31" width="112">
                                        <img src="img/jpeg_files/brand-4.png" class="main-brand__first" alt="brand"
                                             height="31" width="112">
                                    </a>
                                </div>
                            </div>
                ...
                <div>
                    <div class="main-news-item">
                        <div class="main-news-item__left">
                            ...
                            <p class="text-gray hidden-sm-down">Возможен ли сколь-нибудь простой расчет расхода воды по
                                диаметру трубы?
                                Или
                        ...
                        <div class="main-news-item__right">
                            ...
                            <p class="text-gray hidden-md-up">Возможен ли сколь-нибудь простой расчет расхода воды по
                                диаметру трубы?
                                Или
                                единственный способ — обращаться к специалистам ...</p>
...
<div class="main-video-slider">
                        ...
                        <div class="main-video-slider__front--item">
                            <div class="video-slide">
                                ...
                                <div class="video-slide__link">
                                    <a href="#" class="video-modal-launcher" role="button" data-toggle="modal"
                                       data-target="#video-modal" data-address="cNN97OOj7Ag"></a>
                    ...
                    <div>
                        <div class="main-video-slider__front--item">
                            <div class="video-slide">
                                ...
                                <div class="video-slide__link">
                                    <a href="#" class="video-modal-launcher" role="button" data-toggle="modal"
                                       data-target="#video-modal" data-address="Rn-qkLkFS3s"></a>
                                    <object data="img/svg/play.svg" type="image/svg+xml" width="57"
                                            height="57"></object>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="main-video-slider__front--item">
                            <div class="video-slide">
                                ...
                                <div class="video-slide__link">
                                    <a href="#" class="video-modal-launcher" role="button" data-toggle="modal"
                                       data-target="#video-modal" data-address="S6NKwy1fvMw"></a>
                                    <object data="img/svg/play.svg" type="image/svg+xml" width="57"
                                            height="57"></object>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="video-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-video" role="document">
            ...
            <iframe id="iframeYoutube" width="100%" height="475" src="https://www.youtube.com/embed/" frameborder="0"
