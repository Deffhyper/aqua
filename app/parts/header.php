        ...
        <div class="row">
            <div class="header-wrapper col-12">
                ...
                <div class="header-logo">
                    <a href="#">
                        <img src="img/jpeg_files/logo.png" alt="logo" width="" height="">
                    </a>
                </div>
                ...
                <div class="header-ctrl-block">
                    ...
                    <div class="header-cart">
                        ...
                        <div class="header-cart__message">
                            <span>У вас есть <mark>незавершенный заказ</mark></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="header-catalog">
                        <ul class="header-catalog__left">
                            <li class="header-catalog__left--item has-child">
                                <a href="#">О компании</a>
                            ...
                            <li class="header-catalog__left--item">
                                <a href="/">Контакты</a>
                            </li>
                        </ul>
                    </div>
